<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		...
		<section class="our_client">
			...
			<div class="row">
				<div class="span2">
					<a href="#"><img alt="" src="<c:url value ="/assets/user/img/1.png"></c:url>"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt="" src="<c:url value ="/assets/user/img/2.png"></c:url>"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt="" src="<c:url value ="/assets/user/img/3.png"></c:url>"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt="" src="<c:url value ="/assets/user/img/4.png"></c:url>"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt="" src="<c:url value ="/assets/user/img/5.png"></c:url>"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt="" src="<c:url value ="/assets/user/img/6.png"></c:url>"></a>
				</div>
			</div>
		</section>
