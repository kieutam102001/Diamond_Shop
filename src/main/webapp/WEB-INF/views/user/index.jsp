		...
		<div id="sidebar" class="span3">
			<div class="well well-small">
				<ul class="nav nav-list">
					...
					<li><a class="totalInCart" href="cart.html"><strong>San pham da mua
...
-->
					...
					<c:if test="${ new_product.size() > 0 }">
						<div class="item active">
							...
							<c:forEach var="item" items="${ new_product }" varStatus="loop">
								...
								<c:if test="${ (loop.index + 1) % 4 == 0 || (loop.index + 1)  == new_product.size() }">
										</ul>
									</div>
	...
	<div class="well well-small">
			...
			<div class="row-fluid">
				...
				<c:if test="${ highlight_product.size() > 0 }">
					<ul class="thumbnails">
					
					<c:forEach var="item" items="${ highlight_product }" varStatus="loop">
						...
						<c:if test="${ (loop.index + 1) % 3 == 0 || (loop.index + 1)  == highlight_product.size() }">
								</ul>
							<c:if test="${ (loop.index + 1) < highlight_product.size() }">
								<ul class="thumbnails">
							</c:if>
						</c:if> 
