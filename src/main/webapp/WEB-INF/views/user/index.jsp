...
<body>
	...
	<div class="row">
		<div id="sidebar" class="span3">
			...
			<div class="well well-small">
				<a href="#"><img src="<c:url value ="/assets/user/img/paypal.jpg"></c:url>"
			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							...
							VIEW</a> <img src="<c:url value ="/assets/user/img/bootstrap-ecommerce-templates.PNG"></c:url>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="<c:url value ="/assets/user/img/shopping-cart-template.PNG"></c:url>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="<c:url value ="/assets/user/img/bootstrap-template.png"></c:url>"
			...
			<div class="well np">
				<div id="myCarousel" class="carousel slide homCar">
					...
					<div class="item">
						...
						<%-- <div class="item">
							<img style="width: 100%"
								src="<c:url value ="/assets/user/img/slide/carousel1.png"></c:url>"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item active">
							<img style="width: 100%"
								src="<c:url value ="/assets/user/img/slide/carousel3.png"></c:url>"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item">
							<img style="width: 100%"
								src="<c:url value ="/assets/user/img/slide/bootstrap-templates.png"></c:url>"
									...
									<li class="span3">
										<div class="thumbnail">
											<a class="zoomTool" href="product_details.html"
												...
												src="<c:url value ="/assets/user/img/s.jpg"></c:url>" alt=""></a>
										</div>
									</li>
								</ul>
							</div>
